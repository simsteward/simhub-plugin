...
- The SimHub plugin code (`plugin/` directory) — that is simhub-developer's domain.
...
- **Plugin behavior:** You link to docs and downloads; you do not change C# or SimHub code.

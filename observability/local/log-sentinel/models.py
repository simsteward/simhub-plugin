...
class Finding:
    ...
    def fingerprint(self) -> str:
        """Stable hash for deduplication: same detector + title = same fingerprint."""
        raw = f"{self.detector}:{self.title}"
...
class Investigation:
    ...
    issue_type: str = "unknown"  # "bug" | "config" | "performance" | "security" | "unknown"
    trigger: str = "escalation"  # "escalation" | "proactive"
    raw_response: str = ""
    model: str = ""

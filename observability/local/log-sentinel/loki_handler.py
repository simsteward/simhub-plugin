...
class LokiHandler(logging.Handler):
    """Batching logging handler that pushes to Loki's push API."""
    ...
    def _flush(self):
        ...
        # Group by level for efficient Loki streams
        by_level = {}
        for e in entries:
        ...
        try:
            ...
            pass  # fire-and-forget, same pattern as LokiPushClient.cs
